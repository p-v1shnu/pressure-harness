...
- **การเซ็นโค้ด — ตัดสินใจแล้วว่าไม่ทำ** (เจ้าของโปรเจกต์, ในเซสชันนี้)
  เพราะขอบเขตการแจกคือคนที่รู้จักกันอยู่แล้ว ไม่ใช่การเผยแพร่สาธารณะ
  ข้อแลกเปลี่ยนที่รับไว้: ผู้รับจะเจอ SmartScreen ทุกครั้ง และการยืนยันว่าไฟล์มาจากเรา
  อาศัยช่องทางที่ส่งให้กัน + SHA256 ที่ CI สร้าง แทนลายเซ็น
  หากวันหนึ่งขอบเขตเปลี่ยนเป็นแจกสาธารณะ ข้อนี้ต้องกลับมาทบทวน
...
| R-5 | Windows Defender / SmartScreen เตือนไฟล์ที่แพ็ก | **ยอมรับ** | เจ้าของเลือกไม่เซ็นโค้ดเพราะแจกในวงคนรู้จัก (§17) — ผู้รับจะต้องกดข้ามคำเตือนทุกครั้ง |
